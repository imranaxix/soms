...
$payload = [
    ...
    'pp_TxnExpiryDateTime'  => '20260703063950',
...
echo "Exact match test: " . $resp->json('pp_ResponseCode') . " | Msg: " . $resp->json('pp_ResponseMessage') . "\n";
echo "Our Hash: " . $payload['pp_SecureHash'] . "\n";
echo "Jazzcash Hash: " . $resp->json('pp_SecureHash') . "\n";
