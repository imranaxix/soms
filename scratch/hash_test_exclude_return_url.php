...
$filtered = array_filter($payload, function ($value, $key) {
    if ($key === 'pp_ReturnURL') return false; // DO NOT HASH Return URL!
...
echo "Exclude ReturnURL from Hash test: " . $resp->json('pp_ResponseCode') . " | Msg: " . $resp->json('pp_ResponseMessage') . "\n";
