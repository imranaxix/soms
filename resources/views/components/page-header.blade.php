<header class="bg-white px-6 py-5 border-b border-neutral-200 flex items-center justify-between shadow-sm">
    <div class="flex items-center gap-4">
        @if(View::hasSection('back_link'))
            <a href="{{ url()->previous() }}" class="w-10 h-10 flex items-center justify-center bg-white border border-neutral-200 rounded-lg text-neutral-600 hover:bg-neutral-50 transition shadow-sm">
