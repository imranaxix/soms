<header class="h-16 bg-white border-b border-neutral-200 px-6 flex items-center justify-between sticky top-0 z-[190] shadow-sm">
    ...
    <div class="flex items-center gap-2">
        ...
        <!-- Profile -->
        <a href="{{ auth()->user()->role === 'manufacturer' ? route('manufacturer.profile') : route('shop.profile') }}" class="w-8 h-8 flex flex-col items-center justify-center rounded-lg text-neutral-500 hover:bg-neutral-100 transition-all relative" title="profile">
