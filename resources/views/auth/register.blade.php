    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 bg-white overflow-y-auto">
        <div class="w-full max-w-md my-auto">
            ...
            <div class="flex p-1 bg-neutral-100 rounded-xl mb-8">
                <button type="button" id="role-shop" class="flex-1 py-2.5 text-sm font-bold rounded-lg transition-all bg-white text-primary-600 shadow-sm border border-primary-100">
                    Shop Owner
                </button>
                <button type="button" id="role-manufacturer" class="flex-1 py-2.5 text-sm font-bold rounded-lg transition-all text-neutral-500 hover:text-neutral-700">
                    Manufacturer
                </button>
                <input type="hidden" name="role" id="role-input" value="shop_owner">
            </div>
