    ...
    <div class="bg-white p-8 rounded-xl shadow-sm border border-neutral-100 mb-8 mt-4">
        ...
        <form action="#" method="GET" class="flex gap-3">
            <div class="flex-1 relative group">
                <input type="email" class="w-full pl-11 pr-4 py-3.5 bg-neutral-50 border border-neutral-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all group-hover:border-neutral-300" placeholder="Enter manufacturer's email (e.g., mfg@demo.com)">
